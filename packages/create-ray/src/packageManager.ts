...
export function detectPackageManager(env: Record<string, string | undefined> = process.env): PackageManager {
...
export function installDependencies(targetDir: string, pm: PackageManager) {
