...
`;
            ...
            if (finalCode.includes('/@modules/react-dom/client') || finalCode.includes('react-dom/client')) {
                finalCode = finalCode.replace(/import\s*\{\s*createRoot\s*\}\s*from\s*["']\/@modules\/react-dom\/client["']/g, 'import { createRoot as _createRoot } from "/@modules/react-dom/client"').replace(/import\s*\{\s*createRoot\s*\}\s*from\s*["']react-dom\/client["']/g, 'import { createRoot as _createRoot } from "react-dom/client"');
                createRootWrapper = `
