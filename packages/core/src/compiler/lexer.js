...
(function (TokenType) {
    ...
    TokenType["RegExpLiteral"] = "RegExpLiteral";
    ...
    TokenType["TemplateNoSub"] = "TemplateNoSub";
    TokenType["PrivateIdentifier"] = "PrivateIdentifier";
    TokenType["JSXTagOpen"] = "JSXTagOpen";
    TokenType["JSXTagClose"] = "JSXTagClose";
...
export class Lexer {
    ...
    canPrecedeDivision(lastToken) {
        if (!lastToken)
            return false;
        if (lastToken.type === TokenType.Identifier)
            return true;
        if (lastToken.type === TokenType.NumericLiteral)
            return true;
        if (lastToken.type === TokenType.StringLiteral)
            return true;
        ...
        while (this.index < this.length) {
            ...
            if (this.contextStack[this.contextStack.length - 1] === 'jsx-child') {
                if (char !== '<' && char !== '{') {
                    ...
                    const t = { type: TokenType.StringLiteral, value, line: startLine, column: startColumn };
                    tokens.push(t);
                    lastToken = t;
                    continue;
                }
            ...
            if (char === '<' && this.peekAt(1) === '/' && /[a-zA-Z_]/.test(this.peekAt(2) || '')) {
                ...
                const t = { type: TokenType.JSXTagClose, value: tagVal, line: startLine, column: startColumn };
                tokens.push(t);
                lastToken = t;
                if (this.contextStack[this.contextStack.length - 1] === 'jsx-child') {
                    this.contextStack.pop();
            ...
            if (char === '<' && /[a-zA-Z_]/.test(this.peekAt(1) || '')) {
                ...
                const skipJSX = lastToken && (lastToken.type === TokenType.Identifier ||
                ...
                if (!skipJSX) {
                    ...
                    const t = { type: TokenType.JSXTagOpen, value: tagVal, line: startLine, column: startColumn };
                    tokens.push(t);
                    lastToken = t;
            ...
            if (char === '#' && /[a-zA-Z_$]/.test(this.peekAt(1))) {
                ...
                const t = { type: TokenType.PrivateIdentifier, value: name, line: startLine, column: startColumn };
                tokens.push(t);
                lastToken = t;
                continue;
            }
            // ── Decorator: @ ──
            if (char === '@') {
                const t = { type: TokenType.Punctuator, value: this.advance(), line: startLine, column: startColumn };
                tokens.push(t);
                lastToken = t;
                continue;
            }
            ...
            if (/[a-zA-Z_$]/.test(char)) {
                ...
                const t = { type, value: identVal, line: startLine, column: startColumn };
                tokens.push(t);
                lastToken = t;
                continue;
            }
            ...
            const t = { type: TokenType.Punctuator, value: puncVal, line: startLine, column: startColumn };
            tokens.push(t);
            lastToken = t;
    ...
    readTemplateLiteral(startLine, startCol) {
    ...
    readTemplateAfterExpression(startLine, startCol) {
        let val = '}';
        while (this.index < this.length) {
            const c = this.peek();
            if (c === '\\') {
    ...
    readPunctuator(startLine, startCol) {
        const c1 = this.peek();
