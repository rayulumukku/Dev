 ...
 */
export function resolveConditionalExports(exportsValue, importType) {
...
export class Resolver {
     ...
     */
    resolveBarePackage(specifier, startDir, importType) {
     ...
     */
    findPackageDir(packageName, startDir) {
        let dir = startDir;
        while (true) {
     ...
     */
    resolveSubpathImport(specifier, startDir, importType) {
        let dir = startDir;
        while (true) {
                            ...
                            if (key.includes('*')) {
                                ...
                                if (specifier.startsWith(prefix) && specifier.endsWith(suffix || '')) {
                                    ...
                                    if (typeof target === 'string') {
                                        ...
                                        if (resolvedTarget)
                                            resolvedTarget = resolvedTarget.replace('*', match);
                                    }
                                    if (resolvedTarget) {
