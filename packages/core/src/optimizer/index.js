 ...
 */
function computeConfigHash(projectRoot, config) {
 ...
 */
export async function scanDeps(projectRoot, resolver, include = [], exclude = []) {
    await init;
 ...
 */
export async function runOptimizer(projectRoot, config, resolver, options = {}) {
